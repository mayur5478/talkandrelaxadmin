...
import RejectionFocus from '../../analytics/RejectionFocus';
    ...
    <div className="tw-flex tw-flex-col tw-gap-4">
      ...
      <div className="tw-flex tw-items-center tw-justify-between tw-flex-wrap tw-gap-3">
        <div>
          ...
          <p className="tw-text-small tw-text-fg-tertiary tw-mt-1 tw-mb-0">Manage leave, missed session and policy penalties, and review call rejections</p>
        </div>
      </div>
      ...
      <Card flush>
        <Tabs value={key} onChange={setKey}>
          <TabsList ariaLabel="Penalty sections">
            ...
            <Tab value="Call Rejections">Call Rejections</Tab>
          </TabsList>
          ...
          <TabPanel value="Call Rejections">
            <RejectionFocus />
          </TabPanel>
        </Tabs>
      </Card>
